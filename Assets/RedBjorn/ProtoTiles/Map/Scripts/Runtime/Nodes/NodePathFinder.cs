...
namespace RedBjorn.ProtoTiles
{
    ...
    {
        static Dictionary<INode, int> ScoreG = new Dictionary<INode, int>();
        static Dictionary<INode, int> ScoreF = new Dictionary<INode, int>();
        ...
        public static List<INode> Path(IMapNode map, INode start, INode finish, int range)
        {
        ...
        static List<INode> TrimPath(IMapNode map, List<INode> path, int range)
        {
            int distance = 0;
            int trimIndex = -1;
