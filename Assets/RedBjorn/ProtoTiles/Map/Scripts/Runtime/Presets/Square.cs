...
namespace RedBjorn.ProtoTiles
{
    public class Square
    {
        ...
        /// <returns></returns>
        public static int Distance(Vector3Int coord1, Vector3Int coord2)
        {
            return Mathf.CeilToInt(Vector3Int.Distance(coord1, coord2));
        }
        ...
        public static List<Vector3Int> Area(Vector3Int origin, int range)
        {
            var area = new List<Vector3Int>();
            var bottomX = origin.x - range;
            var topX = origin.x + range;
            var bottomZ = origin.z - range;
            var topZ = origin.z + range;
